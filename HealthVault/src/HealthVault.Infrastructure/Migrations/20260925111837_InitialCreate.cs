    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalRecordCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GhanaCardNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ...
                    Country = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false, defaultValue: "Ghana"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_MedicalRecords_Size", "[FileSizeBytes] > 0 AND [FileSizeBytes] <= 10485760");
                    table.ForeignKey(
                        name: "FK_MedicalRecords_AspNetUsers_UploadedByUserId",
                        column: x => x.UploadedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MedicalRecords_MedicalRecordCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "MedicalRecordCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Primary care and walk-in consultations", true, "General Practice" },
                    { 2, "Scheduled outpatient clinics", true, "Outpatient" },
                    { 3, "Diagnostics and specimen processing", true, "Laboratory" },
                    { 4, "Dispensary", true, "Pharmacy" },
                    { 5, "Clinic administration", true, "Administration" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "GENERAL", true, true, "General" },
                    { 2, "LAB", true, false, "Laboratory" },
                    { 3, "IMAGING", true, false, "Imaging" },
                    { 4, "PRESCRIPTION", true, false, "Prescription" },
                    { 5, "DISCHARGE", true, false, "Discharge Summary" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Appointments_Staff_Slot",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalRecordCategories_Code",
                table: "MedicalRecordCategories",
                column: "Code",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalRecords_UploadedByUserId",
                table: "MedicalRecords",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patients_GhanaCardNumber",
                table: "Patients",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Staff_LastName_FirstName",
                table: "Staff",
                columns: new[] { "LastName", "FirstName" });
