...
public class ApiClient
{
    ...
    public ApiClient(HttpClient http, SessionState session)
    {
        ...
        // Safety fallback: ensure it always points to the live Azure API and never localhost in production
        if (_http.BaseAddress == null || _http.BaseAddress.OriginalString.Contains("localhost"))
        {
            _http.BaseAddress = new Uri("https://healthvault-api-app-h3hkd3bcf4exh2bz.ukwest-01.azurewebsites.net/");
        }
    }
